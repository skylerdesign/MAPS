...
<?php include($_SERVER['DOCUMENT_ROOT']."/parts/header.php"); ?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Clinicians</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
	            	<div class="pull-right">
		            	<p><a href="/" class="btn btn-info">Add New Clinician</a></p>
	            	</div>
                </div>
            </div>
            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
										    ...
										    $query = "SELECT * FROM users WHERE user_role=2 order by user_id desc"; 
											...
											while($result = $sth->fetch(PDO::FETCH_OBJ))
											{
												...
												<tr>
		                                            ...
		                                            <td>
			                                            <?php 
			                                            $cid = $result->user_clinic;
					                                    foreach($db->query('SELECT * FROM clinics WHERE clinic_id=' . $cid) as $row) {
